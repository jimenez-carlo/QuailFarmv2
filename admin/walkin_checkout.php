      ...
      <div class="col-12 col-lg-12">
        <div class="card">
                      ...
                      <form method="post" onsubmit="return confirm('Are You Sure?');">
                        ...
                        <div class="input-group mb-2">
                          <div class="input-group-prepend">
                            <button class="btn btn-sm btn-secondary" type="submit" name="update_cart">Update <i data-feather="edit"></i> </button>
                          </div>
          ...
          <form method="post" name="checkout_cart" onsubmit="return confirm('Are You Sure?');">
            <button class="btn btn-lg btn-secondary font-bold rounded-0 w-100" name="checkout_cart" value="1">Checkout Now <i data-feather="check"></i></button>
          </form>
        </div>
      </div>
    </div>
